...
await mind.db.globals.stef._("test").setValue(23)

const res = await mind.db.globals.stef.getJSON()
...
await mind.db.globals.addName('stef')
await mind.db.globals.stef._("prop1").setValue('this is a string')
await mind.db.globals.stef._("prop2").setValue(45.23)
await mind.db.globals.stef._("prop3", "usbprop2").setValue(45.23)
...
const res = await mind.db.globals.stef._("IdontExists").getJSON()
