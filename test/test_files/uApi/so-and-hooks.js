...
describe("uApi app server-code hooks", async () => {
    ...
    it("onTerminate() hook", async () => {

        let ydb = await createYdbInstance('hooks-and-code')
        ...
        ydb = await createYdbInstance('hooks-and-code')
